        ...
        <div class="container">
                ...
                <br>
                         ...
                         <div class="pull-right form-inline"> <br><br>
                            <button class="btn btn-warning" data-toggle='modal' data-target='#add_evento'><a href="logout.php"> Cerrar sesión</a></button>
                        </div>
                ...
                <div class="row">
                        ...
                        <div class="page-header"><h2></h2></div>
                                ...
                                <div class="pull-left form-inline"><br>
                                        ...
                                        <div class="btn-group">
                                            <button class="btn btn-primary" data-calendar-view="year">Año</button>
                                            ...
                                            <button class="btn btn-primary" data-calendar-view="day">Dia</button>
                                        </div>
                                    ...
                                    <div class="pull-right form-inline"><br>
                                        <button class="btn btn-primary" data-toggle='modal' data-target='#add_evento'>Reservar Cita</button>
                                    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="" method="post">
                    ...
                    <label for="to">Finalización</label>
                    ...
                    <select class="form-control" name="class" id="tipo">
                        <option value="event-info">Corte</option>
                        <option value="event-success">Barba</option>
                        <option value="event-important">Mechas</option>
                        <option value="event-warning">Tinte</option>
                    ...
                    <input type="text" required autocomplete="off" name="title" class="form-control" id="title" placeholder="Introduce el Nombre">

                    <br>


                    <label for="body">Servicio</label>
    ...
    <script type="text/javascript">
      ...
      <div class="modal-footer">
          ...
          <button href="http://localhost:8080/calendario/index2.php" type="submit" class="btn btn-success"><i class="fa fa-check" ></i> Agregar</button>
